...
controllerEventos.guardarDb(db)
...
controllerSalonDeFama.guardarDb(db)
const controllerEquipo = require("../controllers/controllerOrganizadores");
const controllerSalon = require("../controllers/controllerSalondefama");
...
router.get("/ver-usuarios/traer", controllerSalonDeFama.traerUsuarios)
